...
// 15 Questions - Branching (some questions skipped depending on choice)
const gameData = {
  ...
  "2": { "text": "2. How do you like to relax?", "choices": {
      ...
      "Perched elegantly": [4, ["Tulip Chair","CH07 Shell Chair"]]  // Branch: skip Q3
    }
  },
  ...
  "5": { "text": "5. Pick a material you love:", "choices": {
      ...
      "Plastic": [7, ["Panton Chair","Eames Plastic Armchair DAW"]],  // Branch: skip Q6
  ...
  "8": { "text": "8. How do you entertain guests?", "choices": {
      ...
      "Creative gathering": [10, ["Red and Blue Chair","Panton Chair"]] // Branch: skip Q9
    }
  },
  ...
  "11": { "text": "11. Ideal vacation seating?", "choices": {
      ...
      "Design exhibition": [13, ["Red and Blue Chair","Panton Chair"]] // Branch: skip Q12
    }
  },
